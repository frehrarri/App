...
export async function init() {
    let partial = await getAdminSettingsPartial();
    document.getElementById("admin-settings-container").innerHTML = partial;
...
export async function getAdminSettingsPartial() {
    const response = await getPartial("Settings", "AdminSettingsPartial");
...
async function handleTabs(e) {
    ...
    //else if (tab.dataset.tab === "TeamPermissions") {
    //    activeTab.classList.remove('active');
    //    e.target.classList.add('active');
    //    //await loadModule("manageTeams");
    //}

    //else if (tab.dataset.tab === "DepartmentPermissions") {
    //    activeTab.classList.remove('active');
    //    e.target.classList.add('active');
    //    //await loadModule("manageDepartments");
    //}

    //else if (tab.dataset.tab === "RolePermissions") {
    //    activeTab.classList.remove('active');
    //    e.target.classList.add('active');
