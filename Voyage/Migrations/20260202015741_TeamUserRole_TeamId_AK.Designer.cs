...
namespace Voyage.Migrations
{
    ...
    [Migration("20260202015741_TeamUserRole_TeamId_AK")]
    partial class TeamUserRole_TeamId_AK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Voyage.Data.TableModels.TeamUserRole", b =>
                {
                    ...
                    b.HasOne("Voyage.Data.TableModels.Team", "Team")
                        .WithMany("TeamUserRoles")
                        .HasForeignKey("CompanyId", "TeamId")
                        .HasPrincipalKey("CompanyId", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
