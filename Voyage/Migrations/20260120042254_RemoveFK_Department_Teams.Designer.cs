...
namespace Voyage.Migrations
{
    ...
    [Migration("20260120042254_RemoveFK_Department_Teams")]
    partial class RemoveFK_Department_Teams
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Voyage.Data.TableModels.TeamMember", b =>
                {
                    ...
                    b.HasKey("TeamId", "TeamVersion", "CompanyId", "EmployeeId");
            ...
            modelBuilder.Entity("Voyage.Data.TableModels.TeamMember", b =>
                {
                    ...
                    b.HasOne("Voyage.Data.TableModels.Team", "Team")
                        .WithMany("TeamMembers")
                        .HasForeignKey("TeamId", "TeamVersion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
